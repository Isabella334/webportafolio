              ...
              <ul>
                <li v-for="project in projects" :key="project.name">
                  <a
                    ...
                    :class="{ 'hovered': hovered === project.name }"
                  >
                    {{ project.name }}
                  </a>
                </li>
...
/* Estilo de scrollbar estilo años 80 */
...
@media (max-width: 640px) {
  ...
  .monitor-screen {
    ...
    top: 15px;
    box-shadow: 0 0 24px #00ffe744 inset, 0 0 0 4px #222;
  }
